...
document.write('<scr'+'ipt type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDVXVtqGU6KYF-gs8S3Cz_quFJLTz7dhaU&callback=initMap" ></scr'+'ipt>');
...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			longitude: 	 51.4905014,
				icon: 			'images/map.png',
				title: 			'Bojamhoor Trading & Contracting W.L.L',
				open: 			false,
				center: 		true
			},
			address: '<h2>Bojamhoor Trading & Contracting W.L.L</h2><p>Al Jazira Al Arabiya <br> Street (Street 880) Building #22 </p>',
			origins: [
				['25.3081074', '51.4905014'],
				['25.3081074', '51.4905014']
			]
		};
