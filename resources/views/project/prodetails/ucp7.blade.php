      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2>Doha Grand Park – Phase 1 – Underground Car Parking 7A and 7B. <br> <span>Traditional</span></h2>
          </div>
          <div class="col-md-3 no-padding">
             <h4><i class="fa fa-check"></i> <span>Project Status</span> <br>  On going </h4>
          </div>
        </div>
		<div class="slider-container"> 
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/cp7_1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp7_2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp7_3.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp7_4.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp7_5.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp7_6.jpg')}}" class="img-responsive"></div> 
   </div> 
          ...
          <div class="row">
             <div class="col-md-6">
                <ul>
                   ...
                   <li class="clearfix"><span>Project Value  : </span><span>  345,000,000.00  </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span></span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>This project includes construction, completion and maintenance of Underground Car Parking 7A and 7B in Doha Grand Park.
</p>
             </div>
          </div>
        </div>
