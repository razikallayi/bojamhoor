...
<div class="tp-space"></div>    
 ...
 <div class="pro-slider">
      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2>Proposed Development of General Cleaning Project <br> <span>Traditional</span></h2>
          </div>
   ...
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/gcp1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp3.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp4.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp5.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp6.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp7.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp8.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp9.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/gcp10.jpg')}}" class="img-responsive"></div> 
   </div> 
     ...
     <div class="col-md-12 no-padding">
        ...
        <div class="pro-sec">
          <div class="row">
             <div class="col-md-6">
                <ul>
                   <li class="clearfix"><span>Client :</span><span>M/s. Public Works Authority Building Affairs <br> P.O. Box: 22188, Doha - Qatar <br> Tel No. +974 44950077, Fax:  44315311</span></li>
                   <li class="clearfix"><span>Project Value  : </span><span>  221,000,000.00  </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span>23.10.2015</span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>This project includes construction, completion and maintenance of Proposed General Cleaning Project- Administration, Building  Married Accommodation, Junior Grade Accommodation, 5 nos. G+2 Labour Accommodation, Supermarket, Restaurant, etc. and Garbage Bin Equipment Area, Mosque, Office and Guard House, Workshops, Diesel Stations, Truck and Bus Parking Shed, Waste Water Treatment (Recycling) System, Substations etc.
        ...
        <div class="op">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="proj aos-item" data-aos="fade-up"><a href="tbz.html">
