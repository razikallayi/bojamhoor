...
<div class="tp-space"></div>    
 ...
 <div class="pro-slider">
      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2> Officer’s Buildings Number (1 & 2) at Barzan Camp. <br> <span>Traditional</span></h2>
          </div>
   ...
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/obp1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/obp2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/obp3.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/obp4.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/obp5.jpg')}}" class="img-responsive"></div> 
   </div> 
     ...
     <div class="col-md-12 no-padding">
        ...
        <div class="pro-sec">
          <div class="row">
             <div class="col-md-6">
                <ul>
                   <li class="clearfix"><span>Client :</span><span>Private Engineering Office <br> P O Box - 23723,Doha - Qatar. <br> Tel: 4499 8555  <br>Fax: 44998586 </span></li>
                   <li class="clearfix"><span>Project Value  : </span><span>     139,900,000.00     </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span>2017</span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>This project includes construction, completion and maintenance of the Officer’s Buildings Nos. 1 & 2 at Barzan Camp
</p>
             </div>
          </div>
        </div>
