...
<div class="tp-space"></div>    
 ...
 <div class="pro-slider">
      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2> 44 Villas (G+1+PH) Project For M/s. Transind Holding <br> <span>Traditional</span></h2>
          </div>
   ...
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/ff1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/ff2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/ff3.jpg')}}" class="img-responsive"></div> 
   </div> 
     ...
     <div class="col-md-12 no-padding">
        ...
        <div class="pro-sec">
          <div class="row">
             <div class="col-md-6">
                <ul>
                   <li class="clearfix"><span>Client :</span><span>Transind Holding <br> PO BOX 1772  <br>  Tel: 4441 7935, Fax: 4432 3585 </span></li>
                   <li class="clearfix"><span>Project Value  : </span><span>    44,000,000.00    </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span>23.04.2016</span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>For this project, Bojamhoor was responsible for the construction, completion and maintenance of 44 Villas (G+1+PH) Project for M/s. Transind Holding
