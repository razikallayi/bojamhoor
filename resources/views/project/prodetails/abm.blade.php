...
<div class="tp-space"></div>    
 ...
 <div class="pro-slider">
      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2> Development of ABM Military College Package No.1 <br> <span>Traditional</span></h2>
          </div>
   ...
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/abm1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/abm2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/abm3.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/abm4.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/abm5.jpg')}}" class="img-responsive"></div> 
   </div> 
     ...
     <div class="col-md-12 no-padding">
        ...
        <div class="pro-sec">
          <div class="row">
             <div class="col-md-6">
                <ul>
                   <li class="clearfix"><span>Client :</span><span>Private Engineering Office  <br>  P O Box - 23723,Doha - Qatar. <br>  Tel: 4499 8555, Fax: 44998585 </span></li>
                   <li class="clearfix"><span>Project Value  : </span><span>    126,000,000.00    </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span>23.05.2009</span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>This project includes construction of the administration building, officers building, medical building and  the outdoor shooting range building.
</p>
             </div>
          </div>
        </div>
