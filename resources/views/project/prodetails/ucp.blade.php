...
<div class="tp-space"></div>    
 ...
 <div class="pro-slider">
      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2>Doha Grand Park – Phase 1 – Underground Car Parking 5 and 6. <br> <span>Traditional</span></h2>
          </div>
   ...
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/cp1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp3.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp4.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/cp5.jpg')}}" class="img-responsive"></div> 
   </div> 
     ...
     <div class="col-md-12 no-padding">
        ...
        <div class="pro-sec">
          <div class="row">
             <div class="col-md-6">
                <ul>
                   <li class="clearfix"><span>Client :</span><span>Private Engineering Office <br> P O Box - 23723,Doha - Qatar. <br> Tel: 4499 8555 <br> Fax: 44998585 </span></li>
                   <li class="clearfix"><span>Project Value  : </span><span>  313,836,681.80  </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span></span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>This project includes construction, completion and maintenance of underground car parking 5 and 6 in Doha Grand Park.</p>
             </div>
          </div>
        </div>
