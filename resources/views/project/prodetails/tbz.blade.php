...
<div class="tp-space"></div>    
 ...
 <div class="pro-slider">
      ...
      <div class="col-md-12 no-padding">
         <div class="pro-head clearfix">
          <div class="col-md-9 no-padding">
             <h2>Regeneration of Tarek Bin Ziad School ( Design & Build) <br> <span>Design and Build</span></h2>
          </div>
   ...
   <div id="slider" class="slider owl-carousel"> 
      <div class="item"><img src="{{url('project/images/projects/tbz1.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz2.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz3.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz4.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz5.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz6.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz7.jpg')}}" class="img-responsive"></div> 
      <div class="item"><img src="{{url('project/images/projects/tbz8.jpg')}}" class="img-responsive"></div> 
   </div> 
     ...
     <div class="col-md-12 no-padding">
        ...
        <div class="pro-sec">
          <div class="row">
             <div class="col-md-6">
                <ul>
                   <li class="clearfix"><span>Client :</span><span>Private Engineering Office <br> P O Box - 23723,Doha - Qatar.  <br> Tel: 4499 8555 Fax: 44998585
</span></li>
                   <li class="clearfix"><span>Project Value  : </span><span> 183,000,000.00 </span></li>
                   <li class="clearfix"><span>Completion Date : </span><span>27.09.2016</span></li>
                </ul>
             </div>
             <div class="col-md-6">
             <h4>Project Discription</h4>
               <p>This project includes regeneration of the Tarek Bin Ziad School ( Design & Build)</p>
             </div>
          </div>
        </div>
